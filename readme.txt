...
2- : .pkl file that contains the final neural network model that predict the traffic performance metric.
...
The first author Rodrigo Silva-Lopez is open to share all codes and training data upon request to the email rsilval at stanford.edu . Note that the size of all files
involved in the calculation of this paper are bigger than 38 gb of data.
