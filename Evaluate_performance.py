...
def Initial_Population(N_ind,N_bri,bridges):
    list_list_bridges = []
    for i in range(0,N_ind):
        ind_list = []
        for j in range(0,N_bri):
            ind_list.append(random.choice(bridges))

        list_list_bridges.append(ind_list)
    return list_list_bridges
...
retro_num = 20 #number of bridges to be retrofitted
